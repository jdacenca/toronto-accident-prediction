...
class ModelPerformance:
    ...
    def plot_classification_report_radial(self, save_path):
        ...
        report_dict = classification_report(self.y_test, y_pred, output_dict=True, zero_division=1)
        
        # Exclude 'accuracy', 'macro avg', 'weighted avg' from the report
        comments = list(report_dict.keys())[:-3]
        metrics = ['precision', 'recall', 'f1-score']

        # Data Preparation for radial chart
        ...
        ax.set_title(f'Classification Metrics (Radial)', fontsize=14)
