...
try:
    ...
    # param_grid_combined = {
    # 'svm__svm__kernel': ['rbf', 'poly','linear'],
    # 'svm__svm__C': [0.1,1,100],
    # 'svm__svm__gamma': [0.03,3.0],
    # 'svm__svm__degree': [3],
    # 'xg_boost__xgb__learning_rate': [0.25],
    ...
    'xg_boost__xgb__max_depth': [7,8,9],
    'xg_boost__xgb__n_estimators': [200],
    'xg_boost__xgb__subsample': [0.8,0.85],
    'xg_boost__xgb__colsample_bytree': [0.75,0.8,0.85,0.9]
    }
